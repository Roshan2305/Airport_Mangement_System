...
image=Image.open(r"C:\Users\AA\Desktop\5.jpg")
...
def fun8():
    ...
    image=Image.open(r"C:\Users\AA\Desktop\3.jpg")
...
def fun9():
    ...
    image=Image.open(r"C:\Users\AA\Desktop\2.jpg")
    ...
    def fun10():
        ...
        if a=='' or b=='' or c=='':
            messagebox.showerror("Error","Cant leave any field empty")
             ...
             if a!=b:
                 #cur.execute("create table eco(boarding char(20),destination char(20),day char(20),time decimal,class char(30),fare integer)")
                 ...
                 con.commit()
                 cur.execute("select * from eco where boarding='%s' and destination='%s' and day='%s' " %(a,b,c))
                 e1=cur.fetchall()
                 if e1==[]:
...
def fun5():
    ...
    image=Image.open(r"C:\Users\AA\Desktop\4.jpg")
    image=image.resize((400,200),Image.ANTIALIAS)
    photo=ImageTk.PhotoImage(image)
